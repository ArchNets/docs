...
```shell
bash <(curl -sL https://raw.githubusercontent.com/xiaoyaohanyue/archnet-docker-aio/refs/heads/main/init.sh) -i
```
...
```shell
bash <(curl -sL https://raw.githubusercontent.com/xiaoyaohanyue/archnet-docker-aio/refs/heads/main/init.sh) && \
