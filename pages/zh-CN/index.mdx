      ...
      <div className="container relative mx-auto max-w-[90rem] px-6">
        ...
        <div className="relative flex justify-between gap-16">
          <div className="w-full max-w-96 shrink-0 justify-between">
            ...
            <p className="text text-muted-foreground">
             ArchNet 是一个纯粹、专业且完美的开源代理面板工具，旨在成为您学习和实践的理想选择。
            </p>
        ...
        <div className="relative mt-8 grid md:grid-cols-3">
          <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8">
            <SwatchBook />
            <div>
              <h3 className="text-lg font-medium">多协议支持</h3>
              <p className="mt-1 text-sm text-muted-foreground">
                支持多种加密协议管理，例如：shadowsocks，v2ray，trojan 等。
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8">
            <ShieldCheck />
            <div>
              <h3 className="text-lg font-medium">隐私保护</h3>
              <p className="mt-1 text-sm text-muted-foreground">
                不存储用户日志，同时保障用户隐私和安全。
              </p>
            </div>
          ...
          <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8">
            <Component />
            <div>
              <h3 className="text-lg font-medium">设计</h3>
              <p className="mt-1 text-sm text-muted-foreground">
                极简设计确保产品易于使用，同时保持业务逻辑的完整性。
              </p>
            </div>
          </div>
