...
Nodes:
  - PanelType: 'ArchNet' # 面板類型: ArchNet, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
    ...
    ControllerConfig:
      ...
      EnableProxyProtocol: false # 僅適用於 WebSocket 和 TCP
      EnableFallback: false # 僅支持 Trojan 和 Vless
      ...
      CertConfig:
        ...
        Provider: alidns # DNS 證書提供者，獲取完整支持列表請查看: https://go-acme.github.io/lego/dns/
        Email: test@me.com
