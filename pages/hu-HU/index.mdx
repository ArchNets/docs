  ...
  <div className="container relative mx-auto max-w-[90rem] px-6"> 
    ...
    <div className="relative flex justify-between gap-16"> 
      <div className="w-full max-w-96 shrink-0 justify-between"> 
        <h1 className="mb-3 mt-6 text-3xl font-bold lg:text-4xl">
          Üdvözöljük a ArchNet használatában 
        </h1> 
        <p className="text text-muted-foreground">
          A ArchNet egy tiszta, professzionális és tökéletes nyílt forráskódú proxy panel eszköz, amely ideális választás a tanuláshoz és a gyakorláshoz. 
        </p> 
    ...
    <div className="relative mt-8 grid md:grid-cols-3"> 
      <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8"> 
        <SwatchBook /> 
        <div> 
          <h3 className="text-lg font-medium">Több protokoll támogatása</h3> 
          <p className="mt-1 text-sm text-muted-foreground">
            Támogatja a különböző titkosítási protokollok kezelését, például: shadowsocks, v2ray, trojan stb. 
          </p> 
        </div> 
      </div> 
      <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8"> 
        <ShieldCheck /> 
        <div> 
          <h3 className="text-lg font-medium">Adatvédelem</h3> 
          <p className="mt-1 text-sm text-muted-foreground">
            Nem tárolunk felhasználói naplókat, miközben biztosítjuk a felhasználók adatvédelmét és biztonságát. 
          </p> 
        </div> 
      </div> 
      <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8"> 
        <Component /> 
        <div> 
          <h3 className="text-lg font-medium">Tervezés</h3> 
          <p className="mt-1 text-sm text-muted-foreground">
            A minimalista tervezés biztosítja a termék könnyű használatát, miközben megőrzi az üzleti logika integritását. 
          </p> 
        </div> 
      </div> 
