...
Nodes:
  - PanelType: 'ArchNet' # نوع پنل: ArchNet, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
      ...
      SpeedLimit: 0 # Mbps، تنظیمات محلی جایگزین تنظیمات از راه دور می‌شود، 0 به معنای غیرفعال است
    ...
    ControllerConfig:
      ...
      SendIP: 0.0.0.0 # آدرس IP که می‌خواهید بسته را ارسال کنید
      ...
      FallBackConfigs: # پشتیبانی از چندین fallback
        - SNI: # TLS SNI (Server Name Indication)، خالی برای هر چیزی
          Path: # HTTP PATH، خالی برای هر چیزی
