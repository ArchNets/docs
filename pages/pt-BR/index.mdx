  ...
  <div className="container relative mx-auto max-w-[90rem] px-6"> 
    ...
    <div className="relative flex justify-between gap-16"> 
      <div className="w-full max-w-96 shrink-0 justify-between"> 
        <h1 className="mb-3 mt-6 text-3xl font-bold lg:text-4xl">
          Bem-vindo ao ArchNet 
        </h1> 
        <p className="text text-muted-foreground">
          O ArchNet é uma ferramenta de painel de proxy open-source, pura, profissional e perfeita, projetada para ser a escolha ideal para seu aprendizado e prática. 
        </p> 
    ...
    <div className="relative mt-8 grid md:grid-cols-3"> 
      <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8"> 
        <SwatchBook /> 
        <div> 
          <h3 className="text-lg font-medium">Suporte a Múltiplos Protocolos</h3> 
          <p className="mt-1 text-sm text-muted-foreground">
            Suporta a gestão de vários protocolos de criptografia, como: shadowsocks, v2ray, trojan, entre outros. 
          </p> 
        </div> 
      </div> 
      <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8"> 
        <ShieldCheck /> 
        <div> 
          <h3 className="text-lg font-medium">Proteção de Privacidade</h3> 
          <p className="mt-1 text-sm text-muted-foreground">
            Não armazena logs de usuários, garantindo a privacidade e segurança dos usuários. 
          </p> 
        </div> 
      </div> 
      <div className="flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8"> 
        ...
        <div> 
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Um design minimalista que garante que o produto seja fácil de usar, mantendo a integridade da lógica de negócios. 
          </p> 
        </div> 
      </div> 
