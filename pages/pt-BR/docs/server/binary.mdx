...
No prompt de comando do MariaDB, execute o seguinte comando para criar um novo banco de dados archnet_db e definir o conjunto de caracteres como utf8mb4_unicode_ci

```sql
CREATE DATABASE archnet_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```

Em seguida, crie um usuário de banco de dados local e restrinja as permissões desse usuário ao banco de dados recém-criado, usando archnet como nome de usuário e archnet-password como senha do usuário.
...
Endereço de download: `https://github.com/ArchNets/archnet/releases`
...
- Modifique o arquivo de configuração archnet.yaml
...
Logger: # Configuração de log
  FilePath: ./archnet.log # Caminho do arquivo de log, padrão: ./archnet.log
...
MySQL:
  ...
  Username: archnet # Nome de usuário do MySQL, obrigatório
  Password: archnet-password # Senha do MySQL, obrigatório
  Dbname: archnet_db # Nome do banco de dados MySQL, obrigatório
...
Administer:
  Email: admin@archnets.com # Email de login do painel, padrão: admin@archnets.com
...
2. Serviço systemd:
   ...
   - Nome do serviço: archnet
   - Arquivo de configuração do serviço: /etc/systemd/system/archnet.service
   - Comando para iniciar o serviço: systemctl start archnet
   - Comando para parar o serviço: systemctl stop archnet
   - Comando para reiniciar o serviço: systemctl restart archnet
   - Comando para verificar o status do serviço: systemctl status archnet
   - Configuração para iniciar automaticamente na inicialização: systemctl enable archnet
...
4. Logs do serviço: os logs do serviço são, por padrão, gravados no arquivo /usr/local/bin/archnet.log

5. Você pode visualizar os logs do serviço usando `journalctl -u archnet -f`

6. Quando o arquivo de configuração estiver vazio ou não existir, o serviço será iniciado com a configuração padrão, e o caminho do arquivo de configuração será: `./etc/archnet.yaml`,
