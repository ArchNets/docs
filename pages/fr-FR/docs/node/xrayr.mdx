...
# Éditer le fichier de configuration, veuillez vous référer aux options de configuration, enregistrez et continuez
...
Nodes:
  - PanelType: 'ArchNet' # Type de panneau : ArchNet, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
    ...
    ControllerConfig:
      ...
      EnableFallback: false # Supporte uniquement pour Trojan et Vless
