...
MariaDB कमांड लाइन इंटरफेस में, एक नया डेटाबेस archnet_db बनाने के लिए निम्नलिखित कमांड चलाएँ, और चरित्र सेट को utf8mb4_unicode_ci पर सेट करें

```sql
CREATE DATABASE archnet_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```

इसके बाद, एक स्थानीय डेटाबेस उपयोगकर्ता बनाएं, और उस उपयोगकर्ता की अनुमतियों को नए बनाए गए डेटाबेस तक सीमित करें, archnet को उपयोगकर्ता नाम के रूप में और archnet-password को उपयोगकर्ता पासवर्ड के रूप में उपयोग करें।
...
डाउनलोड पता: `https://github.com/ArchNets/archnet/releases`
...
- archnet.yaml कॉन्फ़िगरेशन फ़ाइल को संशोधित करें
...
Logger: # लॉग कॉन्फ़िगरेशन
  FilePath: ./archnet.log # लॉग फ़ाइल का पथ, डिफ़ॉल्ट: ./archnet.log
...
MySQL:
  ...
  Username: archnet # MySQL उपयोगकर्ता नाम, अनिवार्य
  Password: archnet-password # MySQL पासवर्ड, अनिवार्य
  Dbname: archnet_db # MySQL डेटाबेस नाम, अनिवार्य
...
Administer:
  Email: admin@archnets.com # बैकएंड लॉगिन ईमेल, डिफ़ॉल्ट: admin@archnets.com
...
2. systemd सेवा:
   ...
   - सेवा नाम: archnet
   - सेवा कॉन्फ़िगरेशन फ़ाइल: /etc/systemd/system/archnet.service
   - सेवा प्रारंभ करने का आदेश: systemctl start archnet
   - सेवा रोकने का आदेश: systemctl stop archnet
   - सेवा पुनरारंभ करने का आदेश: systemctl restart archnet
   - सेवा स्थिति आदेश: systemctl status archnet
   - सेवा बूट पर स्वचालित रूप से प्रारंभ करने का आदेश: systemctl enable archnet
...
4. सेवा लॉग: सेवा लॉग डिफ़ॉल्ट रूप से /usr/local/bin/archnet.log फ़ाइल में आउटपुट होता है

5. सेवा लॉग देखने के लिए `journalctl -u archnet -f` का उपयोग करें

6. जब कॉन्फ़िगरेशन फ़ाइल खाली या अनुपस्थित होती है, तो सेवा डिफ़ॉल्ट कॉन्फ़िगरेशन के साथ प्रारंभ होती है, कॉन्फ़िगरेशन फ़ाइल का पथ है: `./etc/archnet.yaml`，
