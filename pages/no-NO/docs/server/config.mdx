...
Standardsti for konfigurasjonsfilen er: `./etc/archnet.yaml`, og kan spesifiseres med oppstartparameteren `--config`.
...
Logger: # Loggkonfigurasjon
  FilePath: # Sti til loggfil, standard: ./archnet.log
...
Administer:
  Email: # E-post for administrasjonsinnlogging, standard: admin@archnets.com
...
| ------------- | ------------------------ | :----------------------------------------- |
| ARCHNET_DB     | MySQL-konfigurasjon      | root:password@tcp(localhost:3306)/vpnboard |
| ARCHNET_REDIS  | Redis-konfigurasjon      | redis://localhost:6379                     |
