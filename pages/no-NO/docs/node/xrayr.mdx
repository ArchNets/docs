...
# Rediger konfigurasjonen, vennligst referer til konfigurasjonsalternativene, lagre og fortsett
...
ConnetionConfig:
  ...
  UplinkOnly: 2 # Tidsgrense når nedstrømmen er stengt, sekunder
  DownlinkOnly: 4 # Tidsgrense når forbindelsen er stengt etter at oppstrømmen er stengt, sekunder
  BufferSize: 64 # Den interne hurtigbufferstørrelsen for hver forbindelse, kB
Nodes:
  - PanelType: 'ArchNet' # Paneltype: ArchNet, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
    ...
    ControllerConfig:
      ...
      UpdatePeriodic: 60 # Tid for å oppdatere nodeinfo, hvor mange sekunder.
      ...
      EnableFallback: false # Støtter kun Trojan og Vless
