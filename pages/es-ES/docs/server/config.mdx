...
La ruta predeterminada del archivo de configuración es: `./etc/archnet.yaml`, se puede especificar la ruta del archivo de configuración mediante el parámetro de inicio `--config`.
...
Logger: # Configuración de registro
  FilePath: # Ruta del archivo de registro, predeterminado: ./archnet.log
...
MySQL:
  ...
  Config: # Valores de configuración predeterminados de MySQL charset=utf8mb4&parseTime=true&loc=Asia%2FShanghai
...
Administer:
  Email: # Correo electrónico de inicio de sesión del administrador, predeterminado: admin@archnets.com
...
| ------------------- | ----------------------- | :----------------------------------------- |
| ARCHNET_DB           | Configuración de MySQL  | root:password@tcp(localhost:3306)/vpnboard |
| ARCHNET_REDIS        | Configuración de Redis  | redis://localhost:6379                     |
