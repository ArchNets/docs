...
Para la instalación de Nginx, utilizamos el repositorio oficial de Nginx DEB.
...
En la interfaz de línea de comandos de MariaDB, ejecutar el siguiente comando para crear una nueva base de datos archnet_db y establecer el conjunto de caracteres en utf8mb4_unicode_ci

```sql
CREATE DATABASE archnet_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```

A continuación, crear un usuario de base de datos local y restringir los permisos de ese usuario a la base de datos recién creada, usando archnet como nombre de usuario y archnet-password como contraseña de usuario.
...
Dirección de descarga: `https://github.com/ArchNets/archnet/releases`
...
- Modificar el archivo de configuración archnet.yaml
...
Logger: # Configuración de registro
  FilePath: ./archnet.log # Ruta del archivo de registro, por defecto: ./archnet.log
...
MySQL:
  ...
  Username: archnet # Nombre de usuario de MySQL, obligatorio
  Password: archnet-password # Contraseña de MySQL, obligatorio
  Dbname: archnet_db # Nombre de la base de datos de MySQL, obligatorio
...
Administer:
  Email: admin@archnets.com # Correo electrónico de inicio de sesión en el backend, por defecto: admin@archnets.com
...
2. Servicio systemd:
   ...
   - Nombre del servicio: archnet
   - Archivo de configuración del servicio: /etc/systemd/system/archnet.service
   - Comando para iniciar el servicio: systemctl start archnet
   - Comando para detener el servicio: systemctl stop archnet
   - Comando para reiniciar el servicio: systemctl restart archnet
   - Comando para verificar el estado del servicio: systemctl status archnet
   - Configuración para iniciar el servicio al arrancar: systemctl enable archnet
...
4. Registro del servicio: el registro del servicio se guarda por defecto en el archivo /usr/local/bin/archnet.log

5. Se puede ver el registro del servicio usando `journalctl -u archnet -f`

6. Cuando el archivo de configuración está vacío o no existe, el servicio se iniciará con la configuración predeterminada, la ruta del archivo de configuración es: `./etc/archnet.yaml`,
