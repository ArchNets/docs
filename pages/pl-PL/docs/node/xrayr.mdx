...
Nodes:
  - PanelType: 'ArchNet' # Typ panelu: ArchNet, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
      ...
      DeviceLimit: 0 # Lokalnie ustawienia zastąpią ustawienia zdalne, 0 oznacza wyłączenie
    ...
    ControllerConfig:
      ...
      UpdatePeriodic: 60 # Czas aktualizacji informacji o węźle, ile sekund.
