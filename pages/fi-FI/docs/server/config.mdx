...
Konfiguraatiotiedoston oletuspolku on: `./etc/archnet.yaml`, ja sen voi määrittää käynnistysparametrilla `--config`.
...
Logger: # Lokiasetukset
  FilePath: # Lokitiedoston polku, oletus: ./archnet.log
...
Administer:
  Email: # Taustakirjautumisen sähköposti, oletus: admin@archnets.com
...
| ----------------- | --------------- | :------------------------------------------ |
| ARCHNET_DB         | MySQL-asetukset | root:password\@tcp(localhost:3306)/vpnboard |
| ARCHNET_REDIS      | Redis-asetukset | redis\://localhost:6379                     |
