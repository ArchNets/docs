        ...
        <div className='relative flex justify-between gap-16'>
          ...
          <div className='w-full max-w-96 shrink-0 justify-between'>
            ...
            <h1 className='mb-3 mt-6 text-3xl font-bold lg:text-4xl'>
              Bine ați venit la ArchNet
            </h1>
            <p className='text text-muted-foreground'>
              ArchNet este un instrument de panou proxy deschis, pur, profesional și perfect,
              destinat să fie alegerea ideală pentru învățarea și practica dumneavoastră.
            </p>
        ...
        <div className='relative mt-8 grid md:grid-cols-3'>
          ...
          <div className='flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8'>
            ...
            <div>
              ...
              <h3 className='text-lg font-medium'>Suport pentru multiple protocoale</h3>
              <p className='mt-1 text-sm text-muted-foreground'>
                Suport pentru gestionarea mai multor protocoale de criptare, cum ar fi: shadowsocks,
                v2ray, trojan etc.
              </p>
            </div>
          </div>
          <div className='flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8'>
            ...
            <div>
              ...
              <h3 className='text-lg font-medium'>Protecția intimității</h3>
              <p className='mt-1 text-sm text-muted-foreground'>
                Nu stocăm jurnalele utilizatorilor, asigurând în același timp intimitatea și
          ...
          <div className='flex flex-col gap-y-6 px-2 py-10 md:p-6 lg:p-8'>
            ...
            <div>
              ...
              <p className='mt-1 text-sm text-muted-foreground'>
                Designul minimalist asigură ușurința în utilizare a produsului, menținând în același
                timp integritatea logicii de afaceri.
              </p>
            </div>
          </div>
