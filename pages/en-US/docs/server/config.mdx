...
The default path for the configuration file is: `./etc/archnet.yaml`, which can be specified using the startup parameter `--config`.
...
Logger: # Logging configuration
  FilePath: # Log file path, default: ./archnet.log
...
Administer:
  Email: # Backend login email, default: admin@archnets.com
...
| -------------------- | ------------------- | :----------------------------------------- |
| ARCHNET_DB            | MySQL Configuration | root:password@tcp(localhost:3306)/vpnboard |
| ARCHNET_REDIS         | Redis Configuration | redis://localhost:6379                     |
