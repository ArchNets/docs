...
4. Registro del servicio: los registros del servicio se envían por defecto al archivo /usr/local/bin/archnet.log

5. Se puede ver el registro del servicio con `journalctl -u archnet -f`
