...
Nodes:
  - PanelType: 'ArchNet' # Tipo de panel: ArchNet, SSpanel, V2board, NewV2board, PMpanel, Proxypanel, V2RaySocks
    ApiConfig:
    ...
    ControllerConfig:
      ...
      FallBackConfigs: # Soporta múltiples retrocesos
        - SNI: # TLS SNI (Server Name Indication), vacío para cualquier
          ...
          Dest: 80 # Requerido, destino del retroceso, consulta https://xtls.github.io/config/fallback/ para más detalles.
      ...
      CertConfig:
        ...
        Provider: alidns # Proveedor de certificados DNS, consulta la lista completa de soporte aquí: https://go-acme.github.io/lego/dns/
        Email: test@me.com
